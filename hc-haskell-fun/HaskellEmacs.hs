...
-- hash of all functions: 5c521eeb03993ad3553889a5df1530005a19ba36
...
dispatcher = M.fromList $
  ...
  ] ++ []++[("HC.hello", transform (\ (x1) -> HC.hello x1)),
 ("HC.goodbye", transform (\ (x1) -> HC.goodbye x1)),
...
arityList = []++[("HC.hello", arity HC.hello), ("HC.goodbye", arity HC.goodbye),
